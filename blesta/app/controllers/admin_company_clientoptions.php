    ...
    public function requiredFields()
    {
        ...
        if (!empty($this->post)) {
            ...
            $this->Companies->setSettings(
                $this->company_id,
                ['required_contact_fields' => base64_encode(serialize((array) $this->post['required_contact_fields']))],
                ['required_contact_fields']
            );
            $this->Companies->setSettings(
                $this->company_id,
                ['shown_contact_fields' => base64_encode(serialize((array) $this->post['shown_contact_fields']))],
        ...
        $required_contact_fields = isset($settings['required_contact_fields'])
            ? unserialize(base64_decode($settings['required_contact_fields']))
            : [];
        $shown_contact_fields = isset($settings['shown_contact_fields'])
            ? unserialize(base64_decode($settings['shown_contact_fields']))
            : [];
        $vars = (object)['required_contact_fields' => $required_contact_fields, 'shown_contact_fields' => $shown_contact_fields];
