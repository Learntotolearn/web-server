...
class AdminCompanyEmails extends AppController
{
    ...
    public function mail()
    {
        ...
        if (!empty($this->post)) {
            ...
            $fields = ['html_email', 'mail_delivery', 'smtp_security',
                'smtp_host', 'smtp_port', 'smtp_user', 'smtp_password', 'sendmail_path'];
    ...
    public function mailTest()
    {
        ...
        try {
            if (isset($this->post['mail_delivery']) && $this->post['mail_delivery'] === 'smtp') {
                ...
                if (!empty($this->post['smtp_security'])) {
                    $transport->setEncryption($this->post['smtp_security']);
                }
            } else {
