...
class Invoices extends AppModel
{
     ...
     * @return Record The partially constructed query Record object
     */
    private function getInvoices(array $filters = [], array $options = [])
    {
    ...
    {
        return $this->getInvoices(array_merge($filters, ['client_id' => $client_id, 'status' => $status]))
            ->numResults();
    }
     ...
     */
    private function cacheExtensions()
    {
        return ['json', 'pdf'];
    }
}
